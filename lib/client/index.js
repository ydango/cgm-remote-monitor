...
client.load = function load (serverSettings, callback) {
  ...
  client.plugins = require('../plugins/')(ctx).registerClientDefaults();
  ...
  client.ctx.bus = require('../bus')(client.settings, client.ctx);
  client.ctx.pluginBase = client.plugins.base(majorPills, minorPills, statusPills, bgStatus, client.tooltip, Storages.localStorage);
